...
.. describe:: VirtualEthernetCardLegacyNetworkDeviceName
    ...
    .. py:data:: VirtualEthernetCardLegacyNetworkDeviceName.bridged
    
        
        
    
    .. py:data:: VirtualEthernetCardLegacyNetworkDeviceName.hostonly
    
        
        
    
    .. py:data:: VirtualEthernetCardLegacyNetworkDeviceName.nat
