...
.. describe:: AutoStartWaitHeartbeatSetting
    ...
    .. py:data:: AutoStartWaitHeartbeatSetting.no
    ...
    .. py:data:: AutoStartWaitHeartbeatSetting.systemDefault
    ...
    .. py:data:: AutoStartWaitHeartbeatSetting.yes
