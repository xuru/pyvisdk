...
.. describe:: See also
    ...
    :py:class:`~pyvisdk.mo.host_boot_device_system.HostBootDeviceSystem`,
    :py:class:`~pyvisdk.mo.host_cpu_scheduler_system.HostCpuSchedulerSystem`,
    :py:class:`~pyvisdk.mo.host_datastore_system.HostDatastoreSystem`,
    :py:class:`~pyvisdk.mo.host_date_time_system.HostDateTimeSystem`,
    ...
    :py:class:`~pyvisdk.mo.host_firmware_system.HostFirmwareSystem`,
    :py:class:`~pyvisdk.mo.host_health_status_system.HostHealthStatusSystem`,
    :py:class:`~pyvisdk.mo.host_kernel_module_system.HostKernelModuleSystem`,
    :py:class:`~pyvisdk.mo.host_memory_system.HostMemorySystem`,
    :py:class:`~pyvisdk.mo.host_network_system.HostNetworkSystem`,
    :py:class:`~pyvisdk.mo.host_patch_manager.HostPatchManager`,
    :py:class:`~pyvisdk.mo.host_pci_passthru_system.HostPciPassthruSystem`,
    :py:class:`~pyvisdk.mo.host_power_system.HostPowerSystem`,
    :py:class:`~pyvisdk.mo.host_service_system.HostServiceSystem`,
    ...
    :py:class:`~pyvisdk.mo.host_v_motion_system.HostVMotionSystem`,
...
.. autoclass:: pyvisdk.do.host_config_manager.HostConfigManager
    :members:
    :inherited-members: