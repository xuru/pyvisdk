...
.. describe:: Property of
    ...
    :py:class:`~pyvisdk.mo.dvs_create_spec.DVSCreateSpec`,
    :py:class:`~pyvisdk.mo.dvs_reconfigured_event.DvsReconfiguredEvent`
...
.. describe:: See also
    ...
    :py:class:`~pyvisdk.mo.dvs_policy.DVSPolicy`,
    :py:class:`~pyvisdk.mo.dvs_uplink_port_policy.DVSUplinkPortPolicy`
    
.. autoclass:: pyvisdk.do.dvs_config_spec.DVSConfigSpec
    :members:
    :inherited-members: