...
class AuthorizationManager(BaseEntity):
    ...
    def AddAuthorizationRole(self):
        ...
        :returns: 
        '''
        return self.delegate("AddAuthorizationRole")()
    ...
    def MergePermissions(self):
        ...
        :returns: 
        '''
        return self.delegate("MergePermissions")()
    
    def RemoveAuthorizationRole(self):
        '''Removes a role.
        :rtype: None
        :returns: 
        '''
        return self.delegate("RemoveAuthorizationRole")()
    
    def RemoveEntityPermission(self):
        ...
        :returns: 
        '''
        return self.delegate("RemoveEntityPermission")()
    ...
    def RetrieveEntityPermissions(self):
        ...
        :returns: 
        '''
        return self.delegate("RetrieveEntityPermissions")()
    ...
    def UpdateAuthorizationRole(self):
        ...
        :returns: 
        '''
        return self.delegate("UpdateAuthorizationRole")()