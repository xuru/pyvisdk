...
class SessionManager(BaseEntity):
    ...
    def AcquireLocalTicket(self):
        ...
        :returns: 
        '''
        return self.delegate("AcquireLocalTicket")()
    ...
    def ImpersonateUser(self):
        ...
        :returns: 
        '''
        return self.delegate("ImpersonateUser")()
    ...
    def Login(self):
        ...
        :returns: 
        '''
        return self.delegate("Login")()
    
    def LoginBySSPI(self):
        ...
        :returns: 
        '''
        return self.delegate("LoginBySSPI")()
    
    def LoginExtensionByCertificate(self):
        ...
        :returns: 
        '''
        return self.delegate("LoginExtensionByCertificate")()
    
    def LoginExtensionBySubjectName(self):
        '''Creates a special privileged session that includes the Sessions.ImpersonateUser
        ...
        :returns: 
        '''
        return self.delegate("LoginExtensionBySubjectName")()
    ...
    def SessionIsActive(self):
        ...
        :returns: 
        '''
        return self.delegate("SessionIsActive")()
    ...
    def TerminateSession(self):
        ...
        :returns: 
        '''
        return self.delegate("TerminateSession")()
    
    def UpdateServiceMessage(self):
        ...
        :returns: 
        '''
        return self.delegate("UpdateServiceMessage")()