...
class VirtualApp(ResourcePool):
    ...
    def CloneVApp_Task(self):
        ...
        :returns: 
        '''
        return self.delegate("CloneVApp_Task")()
    ...
    def PowerOffVApp_Task(self):
        ...
        :returns: 
        '''
        return self.delegate("PowerOffVApp_Task")()
    ...
    def UpdateVAppConfig(self):
        ...
        :returns: 
        '''
        return self.delegate("UpdateVAppConfig")()