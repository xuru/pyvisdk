...
class HostHealthStatusSystem(BaseEntity):
    ...
    '''
    def __init__(self, core, name=None, ref=None, type=ManagedEntityTypes.HostHealthStatusSystem):
        # MUST define these
    ...
    def ResetSystemHealthInfo(self):
        ...
        hardware IPMI sensor states latch onto unhealthy states and will stay in
        an unhealth state until the sensor state is reset. This method will
