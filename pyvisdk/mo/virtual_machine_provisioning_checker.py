...
class VirtualMachineProvisioningChecker(BaseEntity):
    ...
    def CheckRelocate_Task(self, vm, spec):
        ...
        :param spec: The specification of where to relocate the virtual machine. In cases where DRS
    ...
    def QueryVMotionCompatibilityEx_Task(self, vm, host):
        ...
        :param vm: The set of virtual machines to analyze for compatibility. All virtual machines are
        assumed to be powered-on for the purposes of this operation.

        :param host: The set of hosts to analyze for compatibility. All hosts are assumed to be
