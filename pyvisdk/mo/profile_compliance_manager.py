...
class ProfileComplianceManager(BaseEntity):
    ...
    def CheckCompliance_Task(self, profile, entity):
        ...
        :param profile: to a Profile[]If specified, check compliance against the specified profiles. If
        not specified, use the profiles associated with the entities. If both
        Profiles and Entities are specified, Check the compliance of each Entity
        against each of the profile specified.For more information, look at the
        KMap below.P represents if Profile is specified.E represents if Entity is
        specified.
    ...
    def ClearComplianceStatus(self, profile, entity):
        ...
        :param entity: to a ManagedEntity[]If specified, clear the ComplianceResult related to the
        entity. If profile and entity are not specified, all the ComplianceResults
        will be cleared.
    ...
    def QueryComplianceStatus(self, profile, entity):
        ...
        :param profile: to a Profile[]If specified, compliance result for the specified profiles will be
        returned. This acts like a filtering criteria for the ComplianceResults
        based on specified profiles.

        :param entity: to a ManagedEntity[]If specified, compliance results for these entities will be
        returned. This acts like a filtering criteria for the ComplianceResults
        based on entities.
