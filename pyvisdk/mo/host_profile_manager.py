...
class HostProfileManager(ProfileManager):
    ...
    def ApplyHostConfig_Task(self, host, configSpec):
        ...
        :param host: to a HostSystemHost to which the configuration needs to be applied. Depending on
        the contents of the configSpec, user has to have different privileges to
