...
class HostLocalAccountManager(BaseEntity):
    ...
    def UnassignUserFromGroup(self, group, user):
        ...
        return self.delegate("UnassignUserFromGroup")(group,user)
        

    def AssignUserToGroup(self, group, user):
        ...
        return self.delegate("AssignUserToGroup")(group,user)
