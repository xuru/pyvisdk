...
class HostStorageSystem(ExtensibleManagedObject):
    ...
    def UpdateInternetScsiAuthenticationProperties(self, iScsiHbaDevice, authenticationProperties):
        ...
        return self.delegate("UpdateInternetScsiAuthenticationProperties")(iScsiHbaDevice,authenticationProperties)
    ...
    def UpdateInternetScsiAdvancedOptions(self, iScsiHbaDevice, options):
        ...
        return self.delegate("UpdateInternetScsiAdvancedOptions")(iScsiHbaDevice,options)
    ...
    def SetMultipathLunPolicy(self, policy, lunId):
        ...
        return self.delegate("SetMultipathLunPolicy")(policy,lunId)
    ...
    def AttachVmfsExtent(self, extent, vmfsPath):
        ...
        return self.delegate("AttachVmfsExtent")(extent,vmfsPath)
    ...
    def ExpandVmfsExtent(self, extent, vmfsPath):
        ...
        return self.delegate("ExpandVmfsExtent")(extent,vmfsPath)
        

    def UpdateInternetScsiDigestProperties(self, iScsiHbaDevice, digestProperties):
        ...
        return self.delegate("UpdateInternetScsiDigestProperties")(iScsiHbaDevice,digestProperties)
