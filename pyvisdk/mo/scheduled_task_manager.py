...
class ScheduledTaskManager(BaseEntity):
    ...
    def RetrieveEntityScheduledTask(self, entity):
        ...
        :param entity: to a ManagedEntityThe entity. If null, all scheduled tasks are returned for visible entities.
