...
class InventoryView(ManagedObjectView):
    ...
    def CloseInventoryViewFolder(self, entity):
        ...
        objects until their parent is closed.May partially succeed if some entities
    ...
    def OpenInventoryViewFolder(self, entity):
        ...
        objects are also returned. If a ComputeResource is returned, the implicit root
        ResourcePool and HostSystem objects are also returned.May partially succeed if
        some entities could not be resolved. The operation will still succeed for all
