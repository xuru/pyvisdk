...
def VimEsxCLIstoragecorepluginlistPsaPlugin(vim, *args, **kwargs):
    obj = vim.client.factory.create('ns0:VimEsxCLIstoragecorepluginlistPsaPlugin')
    ...
    required = [  ]
    optional = [ 'Pluginclass', 'Pluginname' ]
