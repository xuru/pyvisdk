...
def ClusterFailoverResourcesAdmissionControlPolicy(vim, *args, **kwargs):
    ...
    does not have reservations, meaning that the reservation is 0, a default of 0MB
    memory and 256MHz CPU is applied. This is controlled by the same HA advanced
    options used for the failover level policy
    ...
    signature = [ 'cpuFailoverResourcesPercent', 'memoryFailoverResourcesPercent' ]
    inherited = [  ]
