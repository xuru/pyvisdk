...
def VimEsxCLIhardwarememorygetMemory(vim, *args, **kwargs):
    obj = vim.client.factory.create('ns0:VimEsxCLIhardwarememorygetMemory')
    ...
    required = [  ]
    optional = [ 'NUMANodeCount', 'PhysicalMemory' ]
