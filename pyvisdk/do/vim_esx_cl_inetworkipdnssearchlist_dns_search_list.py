...
def VimEsxCLInetworkipdnssearchlistDNSSearchList(vim, *args, **kwargs):
    obj = vim.client.factory.create('ns0:VimEsxCLInetworkipdnssearchlistDNSSearchList')
