...
def VimEsxCLInetworkfirewallgetFirewall(vim, *args, **kwargs):
    obj = vim.client.factory.create('ns0:VimEsxCLInetworkfirewallgetFirewall')
    ...
    required = [  ]
    optional = [ 'DefaultAction', 'Enabled', 'Loaded' ]
