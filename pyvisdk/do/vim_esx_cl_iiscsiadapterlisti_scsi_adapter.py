...
def VimEsxCLIiscsiadapterlistiScsiAdapter(vim, *args, **kwargs):
    obj = vim.client.factory.create('ns0:VimEsxCLIiscsiadapterlistiScsiAdapter')
    ...
    required = [  ]
    optional = [ 'Adapter', 'Description', 'Driver', 'State', 'UID' ]
