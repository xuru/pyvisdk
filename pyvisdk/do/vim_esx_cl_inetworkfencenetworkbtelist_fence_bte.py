...
def VimEsxCLInetworkfencenetworkbtelistFenceBTE(vim, *args, **kwargs):
    obj = vim.client.factory.create('ns0:VimEsxCLInetworkfencenetworkbtelistFenceBTE')
    ...
    required = [  ]
    optional = [ 'InnerMac', 'OuterMac', 'Vlan' ]
