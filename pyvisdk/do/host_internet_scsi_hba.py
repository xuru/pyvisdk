...
def HostInternetScsiHba(vim, *args, **kwargs):
    ...
    required = [ 'authenticationCapabilities', 'authenticationProperties',
        ...
        'status' ]
    optional = [ 'advancedOptions', 'configuredSendTarget', 'configuredStaticTarget',
        'currentSpeedMb', 'digestCapabilities', 'digestProperties', 'iScsiAlias',
        'maxSpeedMb', 'supportedAdvancedOptions', 'driver', 'key', 'pci',
