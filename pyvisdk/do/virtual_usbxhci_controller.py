...
def VirtualUSBXHCIController(vim, *args, **kwargs):
    '''The VirtualUSBXHCIController data object describes a virtual USB Extensible
    ...
    optional = [ 'autoConnectDevices', 'device', 'backing', 'connectable', 'controllerKey',
