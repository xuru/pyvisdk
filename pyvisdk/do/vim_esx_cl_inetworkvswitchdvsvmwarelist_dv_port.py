...
def VimEsxCLInetworkvswitchdvsvmwarelistDVPort(vim, *args, **kwargs):
    obj = vim.client.factory.create('ns0:VimEsxCLInetworkvswitchdvsvmwarelistDVPort')
    ...
    required = [  ]
    optional = [ 'Client', 'DVPortgroupID', 'InUse', 'PortID' ]
