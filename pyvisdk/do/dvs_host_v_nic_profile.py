...
def DvsHostVNicProfile(vim, *args, **kwargs):
    '''The DvsHostVNicProfile data object describes the IP configuration for a host
    Virtual NIC connected to a distributed virtual switch. The ipConfig property
    contains the Virtual NIC IP address. If a profile plug-in defines policies or
