...
def VimEsxCLInetworknicgetNICDriverInfo(vim, *args, **kwargs):
    obj = vim.client.factory.create('ns0:VimEsxCLInetworknicgetNICDriverInfo')
    ...
    required = [  ]
    optional = [ 'BusInfo', 'Driver', 'FirmwareVersion', 'Version' ]
