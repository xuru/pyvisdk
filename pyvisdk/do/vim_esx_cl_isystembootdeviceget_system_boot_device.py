...
def VimEsxCLIsystembootdevicegetSystemBootDevice(vim, *args, **kwargs):
    obj = vim.client.factory.create('ns0:VimEsxCLIsystembootdevicegetSystemBootDevice')
    ...
    required = [  ]
    optional = [ 'BootFilesystemUUID', 'BootNIC' ]
