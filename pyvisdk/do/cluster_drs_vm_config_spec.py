...
def ClusterDrsVmConfigSpec(vim, *args, **kwargs):
    '''To update the DRS configuration of a virtual machine, a copy of this object is
    included in the ClusterConfigSpecEx object passed to the method
    ...
    existing configuration; an existing configuration must exist If, instead, this
