...
def VimEsxCLIhardwarecpucpuidgetCpuCpuId(vim, *args, **kwargs):
    obj = vim.client.factory.create('ns0:VimEsxCLIhardwarecpucpuidgetCpuCpuId')
    ...
    required = [  ]
    optional = [ 'EAX', 'EBX', 'ECX', 'EDX', 'Level' ]
