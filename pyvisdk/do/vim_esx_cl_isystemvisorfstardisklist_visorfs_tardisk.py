...
def VimEsxCLIsystemvisorfstardisklistVisorfsTardisk(vim, *args, **kwargs):
    obj = vim.client.factory.create('ns0:VimEsxCLIsystemvisorfstardisklistVisorfsTardisk')
    ...
    required = [  ]
    optional = [ 'Size', 'System', 'TardiskName' ]
