...
def VimEsxCLIesxclicommandlistEsxCliCommand(vim, *args, **kwargs):
    obj = vim.client.factory.create('ns0:VimEsxCLIesxclicommandlistEsxCliCommand')
