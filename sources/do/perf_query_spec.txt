...
.. class:: pyvisdk.do.perf_query_spec.PerfQuerySpec
    ...
    .. py:attribute:: intervalId
        ...
        The interval (samplingPeriod), in seconds, for the performance statistics. For aggregated information, use one of the historical intervals for this property. See PerfInterval for more information. * To obtain the greatest detail, use the providers refreshRate for this property.
        
    
    .. py:attribute:: maxSample
