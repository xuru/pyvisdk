...
.. describe:: HostLowLevelProvisioningManagerReloadTarget

    The target of the disk reload.
    
    
    .. py:data:: HostLowLevelProvisioningManagerReloadTarget.currentConfig
    
        Specifies the reload of the current config of the virtual machine.
        
    
    .. py:data:: HostLowLevelProvisioningManagerReloadTarget.snapshotConfig
